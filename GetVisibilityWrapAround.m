function [visibilityMatrix, meanSeparation] = ...
    GetVisibilityWrapAround(boidPositions, maxPositions,visibilityRange)
...
for i = 1:numberOfBoids
    for j = i+1:numberOfBoids
        [xDistSquare, xIndex] = min([...
            (boidPositions(i,1) - boidPositions(j,1) + ...
            maxPositions(1))^2, (boidPositions(i,1) - ...
            boidPositions(j,1))^2, (boidPositions(i,1) - ...
            boidPositions(j,1) - maxPositions(1))^2]);
        
        [yDistSquare, yIndex] = min([...
            (boidPositions(i,2) - boidPositions(j,2) + ...
            maxPositions(2))^2, (boidPositions(i,2) - ...
            boidPositions(j,2))^2, (boidPositions(i,2) - ...
            boidPositions(j,2) - maxPositions(2))^2]);
        
        [zDistSquare, zIndex] = min([...
            (boidPositions(i,3) - boidPositions(j,3) + ...
            maxPositions(3))^2, (boidPositions(i,3) - ...
            boidPositions(j,3))^2, (boidPositions(i,3) - ...
            boidPositions(j,3) - maxPositions(3))^2]);
